...
interface UnitCandidatesProps {
  ...
  knowledgeSearchElement?: React.ReactNode;
}
...
const UnitCandidates: React.FC<UnitCandidatesProps> = ({
  ...
  return (
    <div className="mb-6 pb-5 border-b border-gray-200">
      <h3 className="text-gray-600 mb-3 text-lg font-bold pb-2 border-b-2 border-indigo-500">단원 후보</h3>

      {/* 후보 섹션 */}
      {unitCandidates.length > 0 && (
        <div className="mb-4">
          <div className="font-semibold text-gray-500 mb-2 text-sm">후보</div>
      ...
      {/* 추가 섹션 */}
      <div className="mb-3">
        <div className="font-semibold text-gray-500 mb-2 text-sm">추가</div>
